...
enum _sp {
	...
	SP_KF_MOBGID, SP_KF_MOBID, SP_KF_MOBLVL, SP_DRESSROOMSTATE,
	SP_PVP_RANKING, SP_PVP_POINTS, SP_PVP_KILLS, SP_PVP_DEATHS, SP_PVP_STREAK, SP_PVP_KILLED, SP_PVP_KILLER, SP_PVP_POSITION,
	SP_PVP_MAXSTREAK, SP_PVP_ANNOUNCER,
